...
class TestCrearEncomienda:
    ...
    def test_remitente_igual_destinatario_devuelve_400(self):
        ...
        assert (
            'destinatario' in response.data.get('detail', {})
            or 'non_field_errors' in response.data.get('detail', {})
        )
    ...
    def test_peso_negativo_devuelve_400_con_campo(self):
        ...
        assert response.status_code == status.HTTP_400_BAD_REQUEST
        assert 'peso_kg' in response.data.get('detail', {})
    ...
    def test_codigo_sin_prefijo_devuelve_400(self):
        ...
        assert response.status_code == status.HTTP_400_BAD_REQUEST
        assert 'codigo' in response.data.get('detail', {})
