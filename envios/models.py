...
class Empleado(models.Model):
    ...
    # Aquí cerramos correctamente el campo estado
    estado = models.IntegerField(
        choices=EstadoGeneral.choices,
        default=EstadoGeneral.ACTIVO
    )

    # Este campo debe ir al mismo nivel que los demás
...
class Encomienda(models.Model):
    ...
    def save(self, *args, **kwargs):
        """Ejecutar full_clean() antes de guardar para validar en el Shell"""
        self.full_clean()
